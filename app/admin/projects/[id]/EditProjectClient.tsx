...
import ProjectKmzUpload from "@/components/admin/project-kmz-upload";
    ...
    <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
            ...
            <div>
            <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Editar Projeto</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-1 font-medium">Atualize os dados do contrato.</p>
            </div>
        </div>
        ...
        <button 
            ...
            title="Excluir projeto (Em breve)"
        >
      ...
      <div className="rounded-[1.5rem] border border-white/20 dark:border-white/10 bg-white/60 dark:bg-black/40 backdrop-blur-xl shadow-xl overflow-hidden p-8">
        <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight mb-6">
          Gerenciamento de Traçado (KMZ)
        </h2>
        <ProjectKmzUpload 
          projectId={project.uuid}
          currentKmzUrl={project.kmzUrl}
