...
export default function ExecucoesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Erro na página de execuções:", error);
  }, [error]);
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Não foi possível carregar a lista de execuções. Verifique sua conexão e tente novamente.
          </p>
        </div>
